...
var app = (function() {
   ...
   var app = {
      ...
      clickToOpenContent: function(contents, selector) {
         ...
         document
            .querySelectorAll(".text-content__story")
      ...
      arrangePhotosWithinText: function() {
         let storyParagraphs = document.querySelectorAll(
            ".is-open .text-content__story p"
         );
         let storyImages = document.querySelectorAll(
            ".is-open .story-images img"
         );
